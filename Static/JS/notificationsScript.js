...
//responsible for managing a collection of notifications and handling their spawning, removal, and animation.
class NotificationCenter {
	constructor() {
		this.items = [];  // active notifications
		this.itemsToKill = [];  // the notifications that are marked for removal
