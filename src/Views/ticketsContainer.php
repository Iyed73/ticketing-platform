    ...
    <?php foreach ($tickets as $ticket): ?>
        <div class="card ticket-card mb-4">
            <div class="card-body">
                ...
                <a href="ticket?action=view&ticket_id=<?php echo $ticket['ticket_id']; ?>&buyer_id=<?php echo $ticket['buyer_id']; ?>" class="btn btn-primary text-white" onclick="openInNewTab(this.href); return false;">View Ticket PDF</a>
                <a href="ticket?action=download&ticket_id=<?php echo $ticket['ticket_id']; ?>&buyer_id=<?php echo $ticket['buyer_id']; ?>" class="btn btn-primary text-white">Download Ticket PDF</a>
