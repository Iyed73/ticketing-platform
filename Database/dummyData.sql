...
INSERT INTO users (firstname, lastname, email, pwd, role, is_verified) VALUES ('Ahmed', 'Ghali', 'ahmedghali@gmail.com', '$2y$12$WFzkKn9UtpBWS7HYXH8n/e/c0IornFVFDrNRpEXGx4RGR7KuxK5KG', 'admin', TRUE);
INSERT INTO users (firstname, lastname, email, pwd, role, is_verified) VALUES ('Mohamed', 'Jaziri', 'mohamedjaziri@gmail.com', '$2y$12$WFzkKn9UtpBWS7HYXH8n/e/c0IornFVFDrNRpEXGx4RGR7KuxK5KG', 'customer', TRUE);
...
VALUES
    ...
    ('Tunisian Football Championship Final', 'Amazing match','Stade Olympique de Radès', 'Dont miss the thrilling climax of the Tunisian Football Championship as the top teams battle it out for glory in the final match.',  'Tunisian Football Federation', 25000, 25000,  '2024-04-01', '2024-05-30', 1500, 'Static/Images/image5.png', 'Sports'),
